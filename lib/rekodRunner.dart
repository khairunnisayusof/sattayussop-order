...
class selectRekodRunner extends StatefulWidget {
  const selectRekodRunner({super.key});

  @override
  State<selectRekodRunner> createState() => _selectRekodRunnerState();
}

class _selectRekodRunnerState extends State<selectRekodRunner> {
  ...
  Widget build(BuildContext context) {
      ...
      child: Padding(
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            ListView.builder(
              primary: false,
              itemCount: rekod_Runner.length,
              shrinkWrap: true,
              itemBuilder: (BuildContext context, int index) {
                rekodRunner current = rekod_Runner.elementAt(index);
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Rekod Runner", style: TextStyle(color: Colors.white)),
        actions: <Widget>[],
        centerTitle: true,
      ),
            ...
            actions: <Widget>[
              ...
              TextButton(
                ...
                onPressed: () {
                  ...
                  String telefon = myController2.text;
                  current.nama = nama;
              ...
              TextButton(
                ...
                onPressed: () {
                  ...
                  if (formKey.currentState!.validate()) {
                    ...
                    String nama = myController.text.capitalizeEach();
                    String telefon = myController2.text;
                    insertServer(rekodRunner(nama, telefon), index);
                  }
                  // Handle the submit action
                },
              ),
  ...
  void addItem(rekodRunner usr, int index) {
    final index = rekod_Runner.indexWhere((e) => e.id == usr.id);

    index >= 0 ? rekod_Runner[index] = usr : rekod_Runner.add(usr);
